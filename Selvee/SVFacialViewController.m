...
#import "SVFacialViewController.h"
#import "DetectFace.h"

@interface SVFacialViewController () <DetectFaceDelegate>
...
@implementation SVFacialViewController
...
- (void)detectedFaceController:(DetectFace *)controller features:(NSArray *)featuresArray forVideoBox:(CGRect)clap withPreviewBox:(CGRect)previewBox
{
    ...
    for (CIFaceFeature *ff in featuresArray) {
        ...
        // TODO: Might have to check relative to screen mid
        if (faceRect.origin.x > 150) {
            // TODO: Turn left
        } else if (faceRect.origin.x < 30) {
            // TODO: Turn right
        }
        NSLog(@"%f", faceRect.origin.x);
